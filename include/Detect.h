...
private:
    ...
    cv::Rect scaleBoxToOriginal(const cv::Rect &input_box,
...
private:
    ...
    int detection_attribute_size; // Attributes (e.g., bbox, class) per
                                  // detection
    int num_classes =
        21; // Number of classes (e.g., COCO dataset has 80 classes)
